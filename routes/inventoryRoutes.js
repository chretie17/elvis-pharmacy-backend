...
router.get('/', verifyToken(['Inventory Manager', 'Admin', 'Pharmacist']), inventoryController.getAllInventory);
router.get('/:id', verifyToken(['Inventory Manager', 'Admin', 'Pharmacist']), inventoryController.getInventoryItemById);
